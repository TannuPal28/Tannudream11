...
public class LoginActivity extends AppCompatActivity implements ResponseManager, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setStatusBarColor(Color.parseColor("#650c10"));
        ...
        binding.tvLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (EmailorMobile.equals("")){
                    ShowToast(context,"Enter Mobile");
                }
                else {
                    SLoginType = "Normal";
                    callLoginApi(true);
    ...
    public void getResult(Context mContext, String type,String message, JSONObject result) {
        ...
        if (type.equals(LOGINTYPE)){
            ...
            try {
                ...
                OTP = result.getString("password");

                    Validations.hideProgress();
                    binding.etEmailMobile.setText("");
                    binding.etPassword.setText("");
                    Intent i = new Intent(activity, LoginOtpAtivity.class);
