...
public class ContestListActivity extends AppCompatActivity implements ResponseManager {
    ...
    public static String IntentMatchId, IntentTime, IntenTeamsName, IntentTeamOneName, IntentTeamTwoName, MyTeamEditorSave, MyContestCode = "",
            ContestBonusPercent, Intentteamoneshortname, Intentteamtwoshortname;
...
LinearLayout contestline ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Intentteamoneshortname=getIntent().getStringExtra("teamoneshortname");
            Intentteamtwoshortname=getIntent().getStringExtra("teamtwoshortname");
        ...
        binding.inclVsBck.tvHeadTeamOneName.setText(Intentteamoneshortname);
        binding.inclVsBck.tvHeadTeamTwoName.setText(Intentteamoneshortname);


        binding.inclVsBck.tvContestTimer.setText(ContestListActivity.IntentTime);

contestline = binding.head.contestline;
contestline.setVisibility(View.VISIBLE);
binding.head.teamsname.setText(Intentteamoneshortname + " v " + Intentteamtwoshortname);
        ...
        Validations.CountDownTimer1(IntentTime, binding.head.time );
        binding.inclVsBck.RLContestHead.setVisibility(GONE);
        binding.head.time.setText(binding.head.time.getText().toString()+" left");
    ...
    public void getResult(Context mContext, String type, String message, JSONObject result) {
        if (type.equals(WINNINGINFOLISTTYPE)) {
            ...
            binding.tvNoDataAvailable.setVisibility(GONE);
    ...
    public void onError(Context mContext, String type, String message) {
        ...
        if (type.equals(CONTESTLISTTYPE)) {
            ...
            binding.RvContestList.setVisibility(GONE);
        } else if (type.equals(MYTEAMLISTTYPE)) {
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            try {
                ...
                if (!ContestBonusPercent.equals("0")) {
                    ...
                    holder.tv_Contest_bonus_msg.setVisibility(GONE);
                }
            }catch (Exception ex){
                holder.tv_Contest_bonus_msg.setVisibility(GONE);
            }
