...
import com.elevendreamer.fragment.FragmentReferBin;
import com.elevendreamer.fragment.Games;
import com.elevendreamer.fragment.HomeFragment;
import com.elevendreamer.fragment.MyContestFragment;
import com.elevendreamer.fragment.dream_coins;
...
public class HomeActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener, ResponseManager {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // binding.imgRv.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));
        //Image_Adapter adapter = new Image_Adapter(this, imageList);
            ...
            public void onTabSelected(com.google.android.material.tabs.TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        replaceFragment(new dream_coins());
                        binding.head.setVisibility(View.GONE);
                        binding.imAppIcon.setVisibility(View.VISIBLE);
                        logo.setVisibility(View.GONE);

                        break;
                    case 3:
                        replaceFragment(new FragmentReferBin());
                        binding.head.setVisibility(View.VISIBLE);
                        logo.setVisibility(View.GONE);
                        title.setVisibility(View.VISIBLE);
                        title.setText("Refer & win");
                        break;
                    default:
                        replaceFragment(new Games());
                        binding.head.setVisibility(View.VISIBLE);
                        break;
                }
            }
